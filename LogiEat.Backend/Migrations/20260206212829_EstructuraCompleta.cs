        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdEstadoPedido = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bitacora_EstadoPedidos_IdEstadoPedido",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UsuarioAdminAprobadorId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Pedidos_EstadoPedidos_IdEstadoPedido",
                        column: x => x.IdEstadoPedido,
                        principalTable: "EstadoPedidos",
                        principalColumn: "IdEstadoPedido",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Precio = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Fecha = table.Column<DateTime>(type: "datetime2", nullable: false),
                    TipoEstado = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_detalles_producto", x => x.id_detalle);
                    table.ForeignKey(
                        name: "FK_detalles_producto_Productos_IdProducto",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdPedido = table.Column<int>(type: "int", nullable: false),
                    IdProducto = table.Column<int>(type: "int", nullable: false),
                    NombreProductoSnapshot = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Pagos_EstadoPago_EstadoPagoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bitacora_IdEstadoPedido",
                table: "Bitacora",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_detalles_producto_IdProducto",
